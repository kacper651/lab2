		...
		while (true) {
			...
			try {
				...
				case 5: {
					...
					case 6: {
						int index = UI.enterInt("Podaj indeks: ");
						operations.addPersonToCollections(currentPerson, index);//demonstracja dodawania elementow do kolekcji
						break;
					}
					case 7: {
					...
					case 8: {
						int index = UI.enterInt("Podaj indeks: ");// demonstracja usuwania elementów z kolekcji
						operations.removeFromCollection(index);
						operations.removeFromSet(currentPerson);
						break;
					}
				case 0:
